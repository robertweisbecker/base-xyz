...
export function Trigger({ ref, className, style, xstyle, ...props }: MenuTriggerProps) {
	const { className: sxClassName, style: sxStyle } = stylex.props(menuTriggerMarker, xstyle);
