...
export function ExperimentsOverviewPage() {
	return (
		<ExperimentPage
			...
			/>
			<ExperimentSection title="What belongs here" description="Use these pages when a component needs realistic surrounding UI or route-level behavior.">
				<Stack gap={2}>
					<Text size="2">Blocks combine repeatable workflows such as approvals, progress, and confirmation.</Text>
					<Text size="2">Components exercise input, popup, and table primitives in product-shaped examples.</Text>
				</Stack>
			</ExperimentSection>
		</ExperimentPage>
	);
