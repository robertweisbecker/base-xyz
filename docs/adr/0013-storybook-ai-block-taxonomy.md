...
password reveal and page chrome.
...
- Leave a block at `Blocks/` when the workflow is product-agnostic:
  password reveal, page chrome, generic confirmation, or generic
...
Current general membership: Confirmation dialog, Page header, Password field,
