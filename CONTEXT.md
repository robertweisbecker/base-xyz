...
- **Description list** — A native name/value association for metadata and key facts; use `List` for ordered or unordered content and `Table` for tabular relationships across columns.
